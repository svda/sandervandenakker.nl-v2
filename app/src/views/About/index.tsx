        ...
        <Section className={classes.overview}>
          <Grid container className={classes.container} spacing={24}>
            <Grid item xs={12} sm={8}>
              <Typography variant="body1" paragraph>For the past ~20 years I have been involved in full stack web development, during which I worked
                for a big data startup called Eccentrade, and for several big corporate clients like UvA, OLVG and MMC.
              </Typography>

              <Typography variant="title" gutterBottom>Background</Typography>
              ...
              <Typography variant="title" gutterBottom>Bonus: 6 reasons why you should NOT hire me</Typography>
              ...
              <Typography variant="body1" paragraph>The constant questioning of how and why certain choices are made and things are organized in a certain way is
              ...
              <Typography variant="body1" paragraph>Only a team where all members are able to both give and take critique, is able to deliver awesome products.
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Typography variant="title" gutterBottom>The official part: Curriculum Vitae</Typography>
              <Typography variant="body1" paragraph>
                <a href="#">View my CV</a> (soon)
              </Typography>
                
              <Typography variant="title" gutterBottom>I have experience in</Typography>
              <Typography variant="body1" paragraph>
